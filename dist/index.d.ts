declare const availableWikis: readonly ["kimetsu-no-yaiba", "koe-no-katachi", "naruto", "shiki", "death-note", "fumetsu-no-anata-e", "one-piece", "dragon-ball", "promised-neverland", "berserk", "jojo", "dororo", "shingeki-no-kyojin"];
